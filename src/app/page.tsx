...
export default function Home(): React.ReactNode {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#F5F5F5] via-[#FFF0E6] to-[#F5F5F5]">
      ...
      {/* Features Section */}
      <section id="features" className="py-12 md:py-20 px-4 md:px-8 bg-white" aria-label="Features">
        <div className="max-w-7xl mx-auto">
      ...
      {/* How It Works */}
      <section id="how-it-works" className="py-12 md:py-20 px-4 md:px-8 bg-gradient-to-br from-gray-50 to-white" aria-label="How It Works">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
              How It Works
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-20 px-4 md:px-8 bg-gradient-to-r from-[#FF6B00] to-[#FF8533]" aria-label="Call to Action">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-12 px-4 md:px-8" aria-label="Footer">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2026 PULSE. All rights reserved. Built for the global community.</p>
          </div>
        </div>
      </footer>
    </main>
